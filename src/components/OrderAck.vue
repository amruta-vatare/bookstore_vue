<template>
  <v-container>
    ...
    <v-row justify="center" style="margin-left: 150px;">
      <v-col justify="center" style="margin-left: 250px;">
        <h2 style="font: normal normal bold 25px/30px Lato;">Order Placed successfully</h2>
      </v-col>
    </v-row>
    <v-row justify="center" style="margin-left: 150px;">
      <v-col justify="center" style="margin-left: 250px;">
        <span>
            hurray!!!! Your order is comfirmed<br>
